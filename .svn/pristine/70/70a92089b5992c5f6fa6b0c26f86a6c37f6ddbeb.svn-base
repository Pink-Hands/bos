...
public class MailJob {
	...
	private String smtpServer;// 发件人服务器
	...
	public void execute() {
		...
		try {
			// 查询工单类型为新单的所有工单
			List<QpWorkbill> list = workbillDao.findAll();
			if (null != list && list.size() > 0) {
				...
				for (QpWorkbill workbill : list) {
					...
					//TODO 设置收件人
					InternetAddress to = new InternetAddress("1286916332@qq.com");
